...
public class ConstructorThreadDemoBoard extends ConstructorThread{
    ...
    protected void createPowerUps() {
        if(blockRow == 12)
            this.elementManager.addElement(new PowerUpsShield((int)board.getSnake().getX()[Environment.getInstance().DOT_NUM-1], -240));
        if(blockRow == 16)
            this.elementManager.addElement(new PowerUpsSpeedUp((int)board.getSnake().getX()[Environment.getInstance().DOT_NUM-1], -240));
    ...
    protected void createCoins() {
        if(blockRow == 6)
            this.elementManager.addElement(new Coin((int)board.getSnake().getX()[Environment.getInstance().DOT_NUM-1], -280));
        if(blockRow == 9)
            this.elementManager.addElement(new Coin((int)board.getSnake().getX()[Environment.getInstance().DOT_NUM-1], -280));
        if(blockRow == 16)
            this.elementManager.addElement(new Coin((int)board.getSnake().getX()[Environment.getInstance().DOT_NUM-1], -280));
