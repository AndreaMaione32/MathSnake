...
public class Market extends JPanel {
    ...
    private JButton buyBlackSkin;
    private JButton setBlackSkin;
    private JButton buyRedSkin;
    private JButton setRedSkin;
    private JButton setDefaultSkin_black;
    private JButton setDefaultSkin_red;
    private JButton buyCloudBackground;
    private JButton setCloudBackground;
    private JButton buyDirtBackground;
    private JButton setDirtBackground;
    private JButton setDefaultBackground_cloud;
    private JButton setDefaultBackground_dirt;
...
@Override
    ...
    private void initMarket() {
        ...
        buyBlackSkin = new JButton("100");
        setBlackSkin = new JButton("SET");
        buyRedSkin = new JButton("200");
        setRedSkin = new JButton("SET");
        setDefaultSkin_black = new JButton("UNSET");
        setDefaultSkin_red = new JButton("UNSET");
        buyCloudBackground = new JButton("100");
        setCloudBackground = new JButton("SET");
        buyDirtBackground = new JButton("200");
        setDirtBackground = new JButton("SET");
        setDefaultBackground_cloud = new JButton("UNSET");
        setDefaultBackground_dirt = new JButton("UNSET");
        l1 = new JLabel("BLACK SKIN");
        l2 = new JLabel("RED SKIN");
        l3 = new JLabel("IN THE CLOUDS BACKGROUND");
        l4 = new JLabel("DIRTY DIRT BACKGROUND");
        setFocusable(true);
    ...
    private void addListeners() {
        ...
        buyBlackSkin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(coinsSaver.getCurrentCoins() >= price) {
                    ...
                    setComponents();
                    try {
                        Environment.getInstance().gc.writeBoughtFeatures();
        ...
        setBlackSkin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Environment.getInstance().gc.writeGraphicConfiguration();
                } catch (IOException ex) {
                    Logger.getLogger(Market.class.getName()).log(Level.SEVERE, null, ex);
                }
                setComponents();
