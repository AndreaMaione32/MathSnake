...
import constructors.ConstructorThreadDemoBoard;
import environment.Environment;

public class DemoBoard extends Board {
    
    private double movementSecond;
    private double SECOND;
    private Timer countdownMovement;
     
    public DemoBoard() {
        super.state = STATE.IN_GAME;
        super.initBoard();
        movementSecond = 50.0;
        SECOND = movementSecond - 2.0;
        countdownMovement = new Timer(500, new ActionListener() {
        @Override
